...
- Parameters: 1.5 trillion (Grok 4.7 successor targeted at 2.1 trillion)
- Predecessor: [[grok-4-5]] ($2/$6 per M tokens, ~4th on Artificial Analysis index)
- Launch target: ~August 7, 2026
- Training improvements: SFT + RL over the 4.5 foundation
- Target intelligence tier: Kimi K3-level per Musk framing (see [[kimi-k3]])
- Benchmark venue: Arena.ai (LMArena) Agent Arena leaderboard scheduled the week after launch
- Positioning: "Opus-class" competitor for coding, agentic workflows, knowledge work

## Open Questions

- Pricing tier vs Grok 4.5's $2/$6 anchor — does Grok 4.6 hold or lift the pricing?
- Compute substrate — Memphis Colossus or extended [[spacex]] Colossus 2 GB300 stack?
- Distribution surfaces — SuperGrok/SuperGrok Heavy/X Premium+/API/[[cursor]] default routing at launch?
- Safety-evaluation posture given the compressed 4.5→4.6→4.7 development cycle
- Independent capability delta vs [[claude-opus-5]] and [[gpt-5-6]] Sol/Terra tiers
