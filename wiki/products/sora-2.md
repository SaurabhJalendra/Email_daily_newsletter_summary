---
name: Sora 2
description: OpenAI's second-generation video model with physics, consistent worlds, synced audio, iOS app
type: product
---
...
- **2025-10-01**: Launched with physics improvements, consistent worlds, synced audio, iOS app — *source: TAAFT "Sora 2 Is Finally Here"; AI Breakfast "OpenAI's Sora 2 is INCREDIBLE"; The Rundown AI "Sora 2 breaks the internet"*

## Key Facts

- Developer: [[openai]]
- Launched: 2025-10-01 (approx)
- Modalities: video with synced dialogue and ambient audio
- Features: face/voice embedding, style transfer, consistent multi-shot worlds
- Distribution: iOS consumer app + API

## Open Questions

- Pricing / API availability details?
- How tight are the post-10-06 copyright guardrails (training data, likeness, IP)?

## Sources

- data/summaries/2025-10-01.json (TAAFT — Sora 2; AI Breakfast — Sora 2 is INCREDIBLE; The Rundown AI — Sora 2 breaks the internet; TLDR AI — OpenAI Sora 2)
