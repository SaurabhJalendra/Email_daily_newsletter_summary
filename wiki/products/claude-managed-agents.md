...
> **Last updated**: 2026-07-24-morning (**Cycle-2 July update — Claude Managed Agents adds **effort controls** for tuning per-agent thinking budget + **500 skills per session** cap for stacking capabilities + **webhooks** for external event integration; framed as "more efficient building of multi-agent systems"**)
