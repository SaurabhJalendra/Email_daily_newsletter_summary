...
> **Last updated**: 2026-06-21-evening (researchFindings.additionalContext recap framing + AI Automation Society Skool weekly digest both re-anchor Opus 4.7 as Anthropic's flagship generally available through Anthropic API + AWS Bedrock + Google Vertex AI + Microsoft Foundry with premium pricing; [[spacex]] Colossus 1 partnership securing 220K NVIDIA GPUs + 300 MW power explicitly framed as *enabling Anthropic to double code-assistant rate limits + substantially raise API limits for Opus models* — first publicly framed *rate-limit/API-limit uplift* attribution to the Colossus 1 lease in this wiki)
> **Status**: active
> **Related**: [[anthropic]], [[claude-code]], [[claude-design]], [[cursor]], [[agent-frameworks]], [[spacex]]
