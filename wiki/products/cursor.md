...
> **Last updated**: 2026-06-09-morning (Cursor ships Design Mode for visual UI editing — point and draw UI changes directly on screen, agent translates visual edits into code)
> **Status**: active
