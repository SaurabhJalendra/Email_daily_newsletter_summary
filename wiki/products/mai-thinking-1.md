...
> **Last updated**: 2026-08-13-evening (**Cycle-3 recoverage — **AINews HIGH lists MAI-Thinking-1 in the *"other notable updates"* cohort alongside [[qwen-3-8-max]] open-weights + [[deepseek-v4]] V4 Pro GA — first publicly framed *cross-frontier-lab tri-model daily-anchor cohort* on MAI-Thinking-1**. AINews HIGH: *"Other notable updates include the release of Qwen3.8-Max open weights, DeepSeek V4 Pro GA, and Microsoft's MAI-Thinking-1"*. First publicly framed on this cycle: (a) *tri-model daily-anchor cohort placement with Qwen3.8-Max + V4 Pro GA* — first publicly framed *MAI-Thinking-1 alongside Chinese-open-weights daily-cohort* framing in this wiki; sharpens Microsoft's *first-party-model + FDE-distribution* posture into a *daily-anchor cross-vendor cohort tier* alongside China-frontier-open-weights releases; (b) *AINews recoverage placement* — cycle-3 sustains MAI-Thinking-1 as *canonical mid-2026 Microsoft-first-party reasoning-tier flagship* despite absence of new benchmark-anchors this cycle. Structurally significant: **AINews cohort-placement alongside Qwen3.8-Max + V4 Pro GA canonicalizes MAI-Thinking-1 as *Microsoft-first-party mid-August-2026 daily-anchor cohort member*** — reads as *Microsoft's first-party MAI-Thinking-1 still-actively-covered-alongside frontier-open-weights daily-cohort* validation despite the model shipping 2+ months prior. See [[microsoft]] + [[qwen-3-8-max]] + [[deepseek-v4]] — *source: data/summaries/2026-08-13-evening.json (AINews HIGH "[AINews] SpaceXAI Grok 4.6 and Grok @Bot")*)
