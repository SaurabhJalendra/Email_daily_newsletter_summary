...
> **Last updated**: 2026-06-09-evening (Opus 4.8 scores ~13% on the hardest subset of the new [[frontiercode]] benchmark from AINews — counter-anchor to SWE-bench Pro / Terminal-Bench 2.1 SOTA framing: coding is *not* "solved" once code-quality / mergeability is what's being measured)
> **Status**: launched
> **Related**: [[anthropic]], [[claude-opus-4-7]], [[claude-code]], [[claude-mythos]], [[claude-sonnet-4-6]], [[gpt-5-5]], [[gemini-3-5-flash]], [[agent-frameworks]]
