---
name: Alpamayo
description: NVIDIA's open-source AI model family for autonomous driving — 10B-parameter models, datasets, simulators
type: product
---
...
- **2026-01-07**: NVIDIA introduces Alpamayo family — open AI models, datasets, and simulators for autonomous driving (CES 2026) — *source: 2026-01-07 cycle (TLDR — Nvidia's new chip)*
- **2025-12-04**: Alpamayo-R1 announced — "human-like perception/reasoning" for autonomous vehicles — *source: 2025-12-04 cycle*
- **2025-12-03**: Open-source DRIVE Alpamayo-R1 released as part of NVIDIA's digital/physical AI stack — *source: 2025-12-03 cycle*

## Key Facts

- Vendor: [[nvidia]]
- Focus: autonomous driving (AV)
...
- Which car OEMs / AV platforms have committed to Alpamayo?
- License terms (Apache 2? NVIDIA Custom?) for the 10B model?
- Performance vs Waymo, Tesla FSD, and Chinese AV stacks on standard benchmarks?
...
- data/summaries/2026-01-10.json (10B parameter AV reasoning model)
- data/summaries/2026-01-11.json (AV reasoning framing)
