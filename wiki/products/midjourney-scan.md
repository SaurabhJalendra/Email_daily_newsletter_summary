...
> **Last updated**: 2026-06-19-morning (**Superhuman second-cohort framing: "around 50,000 of these scanners to be deployed around the world"** + AlphaSignal: "500K sensors, 60-sec body scan, $few" — sharpens the AINews 358K-element / 50K-scanner roadmap into a *deployment* commitment + first publicly framed *per-scan cost* tier ("$few", i.e. a few dollars per scan); productizes the 2026-06-18-evening Midjourney Spa launch into a global-scale deployment plan)
