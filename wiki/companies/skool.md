---
name: Skool
description: Community-and-course platform used as the default hosting layer for AI-automation and AI-education communities like [[ai-automation-society]]
type: company
---
...
Skool is an online community and course-hosting platform that has become a default surface for AI-education communities aimed at operators, freelancers, and small businesses. It combines discussion boards, membership management, and structured learning modules in one product, letting AI-focused creators run cohorts, share implementation resources, and gate paid tiers with weekly live calls. In the AI/ML space, Skool hosts communities like [[ai-automation-society]] — 100K+ own-reported / ~305K+ third-party members focused on no-code AI automation with [[n8n]] and [[claude-code]] — positioning Skool as part of the *AI-education distribution infrastructure* alongside YouTube, Substack, and Discord.
...
- **2026-07-19-evening**: **Created** — Skool identified as the hosting platform for [[ai-automation-society]] (305K+ members); referenced as the venue for the July 20 Q&A with Nate Herk; described as facilitating "structured learning experiences and communities around AI automation" — *source: data/summaries/2026-07-19-evening.json (AI Automation Society (Skool) weekly digest + event invitation)*

## Key Facts

- Product type: community + course platform (discussion boards, memberships, learning modules)
- Notable AI-adjacent tenant: [[ai-automation-society]] (Nate Herk, 100K+ own-reported / ~305K+ third-party members)
- Revenue model: platform fees + gated paid community tiers
- Role in AI/ML ecosystem: distribution and education infrastructure, not a model/tool vendor
...
- Full roster of AI/ML-focused communities hosted on Skool
- Platform take rate and creator economics
- Which model(s) power Skool's platform-level AI moderation (in-house vs OpenAI/Anthropic/etc.)
- Total ARR or GMV signal
- Ownership / funding status
- Whether Link.skool.com telemetry is exposed to community owners (e.g., referral attribution surfaces)
