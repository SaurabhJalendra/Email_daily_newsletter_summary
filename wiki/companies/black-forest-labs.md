...
description: German image-generation lab; ships FLUX model family
type: company
---
...
- Geography: Germany
- Flagship product: [[flux-2]] (Nov 2025)
- Strategic angle: high-fidelity image generation tuned for creative-production workflows

## Open Questions

- Funding / partner status?
- Open-weights vs commercial-only positioning for FLUX.2?
- Video-generation roadmap?

## Sources

- data/summaries/2025-11-27.json (Black Forest Labs FLUX.2)
