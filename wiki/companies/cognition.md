...
> **Last updated**: 2026-06-15-evening (**Import AI 461 (Jack Clark) names FrontierCode in an "Alignment is not on track" essay** — first publicly framed *Anthropic-policy-lead-tier* citation of a Cognition-built benchmark in this wiki; cross-lab signal that Cognition's [[frontiercode]] benchmark has crossed into the alignment-research discourse beyond the original code-quality / war-on-slop framing; pipeline summaries unavailable — tenth consecutive cycle with OpenRouter 403 key-limit-exceeded blocker)
> **Status**: active
