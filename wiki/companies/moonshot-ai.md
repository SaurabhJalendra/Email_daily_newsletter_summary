...
> **Last updated**: 2026-07-16-evening (**Kimi K3 leaked through Moonshot's own platform — promotion page briefly live indicating July 15 launch, then pulled** — leaks describe **~2.5T-parameter, 1M-token model aimed at long-horizon agents, built on a new architecture**, expected to be priced lower than comparable frontier models. World of AI HIGH "OPUS 5 LEAKS 🍯 + Kimi K3 Incoming 👀"; researchFindings adds **"Kimi Linear"** attention hybrid (softmax + linear) + **3-4T ultra-sparse MoE with ~60-80B active params** + **~8× cheaper than GPT-5.5** + likely Apache 2.0. Same-week Anthropic [[honeycomb]] frontier-leak establishes canonical *frontier-preview-through-leaks* pattern. See [[kimi-k3]] (NEW page) — *source: data/summaries/2026-07-16-evening.json (World of AI HIGH; researchFindings.additionalContext for Kimi K3)*)
