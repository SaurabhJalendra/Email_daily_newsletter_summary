...
> **Last updated**: 2026-06-09-evening (Ollama now supports [[hermes-desktop]] — `ollama launch hermes-desktop` ships [[nous-research]]'s self-improving Hermes Agent in a graphical client backed by Ollama local + cloud models)
> **Status**: active
