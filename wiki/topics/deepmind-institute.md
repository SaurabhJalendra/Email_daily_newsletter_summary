---
name: DeepMind Institute
description: Google DeepMind's Sep 2026 in-house think tank directed by Demis Hassabis + Shane Legg + James Manyika; researches safe AGI development, economic and social effects, and institutional adaptation
type: topic
---
...
The DeepMind Institute is Google DeepMind's September 2026 in-house think tank for AGI-preparedness research — a formal organizational vehicle for publishing work on how society should adapt to advanced AI systems. It is directed by three named leaders: Demis Hassabis (DeepMind cofounder + Alphabet chief scientist per prior 2026-08-06-morning anchor), Shane Legg (DeepMind cofounder), and James Manyika (former McKinsey Global Institute chairman + Google SVP for research, technology & society). The trio combines cofounder-tier scientific authority with economist/institutional-adaptation research tradition — reads as a *research-institute-with-cofounder-and-economist leadership canonical anchor*.
...
- **2026-09-17-morning**: **DeepMind Institute launched — Google DeepMind's in-house think tank for AGI-preparedness research** — tokens& MEDIUM: *"DeepMind has launched an 'Institute for AGI' to promote innovative ideas on the safe development, beneficial use, and societal implications of AGI, marking a significant investment in AGI research"*. First-in-wiki *concrete DeepMind Institute-for-AGI named-research-body canonical anchor*. Pairs cycle-structurally with [[openai]] $1.2T + [[anthropic]] $2T IPO as *three-frontier-lab AGI-investment-vector cluster*. See [[google]] + [[agi-timelines]] — *source: data/summaries/2026-09-17-morning.json (tokens& MEDIUM "🦾 OpenAI's $1.2T bet on AGI")*

## Key Facts

- Parent: [[google]] / DeepMind
- Named directors: Demis Hassabis + Shane Legg + James Manyika
- Research scope: (1) safe AGI development, (2) economic and social effects, (3) institutional adaptation
- Methodology framing: "competing ideas and revising views as new evidence emerges"
- Publishing model: publishes research on AGI-preparedness for external audiences
- Cycle-structural pairing: OpenAI $1.2T compute-tier + Anthropic $2T IPO-tier + DeepMind safety-research-institute-tier

## Open Questions

- Initial research agenda / first publication timeline
- Relationship to DeepMind's existing safety-and-ethics teams
- Whether it will maintain independence from Alphabet corporate positioning
- Publications cadence (papers? reports? blog posts?)
- Cross-institutional collaboration — will it partner with academic institutions or other frontier-lab safety groups?
