...
> **Status**: active
> **Related**: [[model-routers]], [[open-source-models]], [[ai-regulation]], [[granola]], [[cursor]], [[claude-code]], [[hugging-face]], [[glm-5-2]], [[minimax]], [[software-factories]], [[conviction]], [[baseten]]

*Cross-reference note (LINT 2026-08-16)*: [[conviction]] — Sarah Guo's ~$1B-AUM VC firm — is the first top-tier VC-voice canonicalization of this "labs-become-metered-input-infrastructure" thesis, with six portfolio companies past $10B including [[baseten]] and Harvey and an explicit *AI-market-is-labor-not-software-budgets* framing that pairs with the accumulation + depth + trust + orchestration + cost-routing archetype cohort.
